 ...
 */
#define DPCAPS_SIGNINGOPTIMIZED     0x00000080
/*
 * This DirectPlay object supports digital signing of messages.
 */
#define DPCAPS_SIGNINGSUPPORTED     0x00000100

/*
 * The service provider bound to this DirectPlay object can optimize
 * encryption of messages.
 */
#define DPCAPS_ENCRYPTIONOPTIMIZED  0x00000200
/*
 * This DirectPlay object supports encryption of messages.
 */
#define DPCAPS_ENCRYPTIONSUPPORTED  0x00000400
...
#define DPERR_INVALIDCREDENTIALS        MAKE_DPHRESULT(  2030 )
#define DPERR_SIGNFAILED                MAKE_DPHRESULT(  2040 )
#define DPERR_CANTLOADSECURITYPACKAGE   MAKE_DPHRESULT(  2050 )
#define DPERR_ENCRYPTIONNOTSUPPORTED    MAKE_DPHRESULT(  2060 )
#define DPERR_CANTLOADCAPI              MAKE_DPHRESULT(  2070 )
#define DPERR_NOTLOGGEDIN               MAKE_DPHRESULT(  2080 )
